...
导航到您的 `docs.json` 文件所在的文档目录，并运行以下命令：
...
CLI 可以帮助验证文档中的链接。要识别任何断开的链接，请使用以下命令：
...
<Frame>
  <img src="/images/checks-passed.png" alt="部署确认消息的截图，显示所有检查都已通过。" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
想了解最新 CLI 版本中有哪些更改？查看 [CLI 更新日志](https://www.npmjs.com/package/mintlify?activeTab=versions)。
