...
<CardGroup cols={3}>
  <Card title="NodeJS" icon="node" href="https://nodejs.org/">
    版本要求 ≥22
  </Card>
  <Card title="PostgreSQL" icon="database" href="https://www.postgresql.org/">
    版本要求 ≥15
  </Card>
  <Card title="Redis" icon="server" href="https://redis.io/">
    版本要求 ≥6.2
  </Card>
</CardGroup>
...
本地部署访问地址：[http://localhost:4090](http://localhost:4090)
